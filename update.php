<?php
// This page will update records in symptoms table.
...
//Set page title
$page_title = 'Update Symptoms Log';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (empty($errors)) { // If everything's OK.
		...
		$q = "UPDATE symptoms SET type_id='$type', start_date='$date', new_old='$new_old', severity='$severity', description='$desc' WHERE sym_id='$sym_id' AND user_id='$user_id'";	
		$r = @mysqli_query ($dbc, $q); // Run the query.
		if ($r) { // If it ran OK.
		
			// Print a message:
			echo '
		</br><center><h2>Your symptom was updated!</h2></center>
